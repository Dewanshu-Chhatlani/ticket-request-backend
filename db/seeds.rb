user1 = User.create(first_name: 'Admin', email: 'admin@requestapp.com', password: 'admin', role: 'admin')
user2 = User.create(first_name: 'Test', email: 'test@requestapp.com', password: 'helloworld')
user3 = User.create(first_name: 'Dewanshu', email: 'dewanshu@requestapp.com', password: 'helloworld')
